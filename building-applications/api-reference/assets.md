<h1> Assets</h1><p>LangStream Version: <strong>0.1.0</strong></p>



<br><h3 data-full-width="true"><a name="astra-keyspace"></a>Astra keyspace (<code>astra-keyspace</code>)</h3><p data-full-width="true">Manage a DataStax Astra keyspace.</p>
...
<br><h3 data-full-width="true"><a name="cassandra-keyspace"></a>Cassandra keyspace (<code>cassandra-keyspace</code>)</h3><p data-full-width="true">Manage a Cassandra keyspace.</p>
...
<br><h3 data-full-width="true"><a name="cassandra-table"></a>Cassandra table (<code>cassandra-table</code>)</h3><p data-full-width="true">Manage a Cassandra table in existing keyspace.</p>
...
<br><h3 data-full-width="true"><a name="jdbc-table"></a>JDBC table (<code>jdbc-table</code>)</h3><p data-full-width="true">Manage a JDBC table.</p>
...
<br><h3 data-full-width="true"><a name="milvus-collection"></a>Milvus collection (<code>milvus-collection</code>)</h3><p data-full-width="true">Manage a Milvus collection.</p>
