...
\
=======
<h1>Agents</h1><p>LangStream Version: <strong>0.2.1-SNAPSHOT</strong></p>
...
=======
<br><h2 data-full-width="true"><a name="vector-db-sink_astra"></a>Cassandra/Astra (<code>vector-db-sink</code>)</h2><p data-full-width="true">Writes data to Apache Cassandra or DataStax Astra service.<br>All the options from DataStax Kafka Sink are supported: https://docs.datastax.com/en/kafka/doc/kafka/kafkaConfigTasksTOC.html</p>
>>>>>>> d816e58 (Agents API Ref: add vector database as single agents)
...
<br><h2 data-full-width="true"><a name="vector-db-sink_cassandra"></a>Cassandra/Astra (<code>vector-db-sink</code>)</h2><p data-full-width="true">Writes data to Apache Cassandra or DataStax Astra service.<br>All the options from DataStax Kafka Sink are supported: https://docs.datastax.com/en/kafka/doc/kafka/kafkaConfigTasksTOC.html</p>
