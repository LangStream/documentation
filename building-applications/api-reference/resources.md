...
## AWS Bedrock (`bedrock-configuration`) <a href="#bedrock-configuration" id="bedrock-configuration"></a>
...
## OpenSearch (`datasource`) <a href="#datasource_opensearch" id="datasource_opensearch"></a>
...
## OpenSearch (`vector-database`) <a href="#vector-database_opensearch" id="vector-database_opensearch"></a>
...
## Solr (`vector-database`) <a href="#vector-database_solr" id="vector-database_solr"></a>
